...
import com.stellarflux.stepik.api.EnvReader
import com.stellarflux.stepik.api.StepikApiClient
import com.stellarflux.stepik.api.StepikAuth
import com.stellarflux.stepik.model.StepData
import com.stellarflux.stepik.model.StepikFileData
import com.stellarflux.stepik.service.StepikProjectService
import com.stellarflux.stepik.sync.StepikSyncService
...
class StepikSplitEditor(
    ...
    private fun fetchCourse(url: String, courseId: Int, credentials: Pair<String, String>) {
        ProgressManager.getInstance()
            .run(object : Task.Backgroundable(project, "Fetching course from Stepik...", true) {
